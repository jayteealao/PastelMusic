    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/jayteealao/pastelmusic/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/jayteealao/pastelmusic.git")
                    developerConnection.set("scm:git:ssh://github.com/jayteealao/pastelmusic.git")
                    url.set("https://github.com/jayteealao/pastelmusic/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/jayteealao/pastelmusic/issues")
                }
            }
        }
    }
